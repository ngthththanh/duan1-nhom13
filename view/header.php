                    ...
                    <ul id="menu-top-bar-right" class="nav menu-top-bar-right">
                        ...
                        <li class="menu-item">
                            <a title="My Account" href="index.php?act=login">
                                <i class="tm tm-login-registe"></i>Register or Sign in</a>
                        </li>
                    </ul>
                    <!-- .nav -->
                </div>
                            ...
                            <nav id="primary-navigation" class="primary-navigation" aria-label="Primary Navigation" data-nav="flex-menu">
                                <ul id="menu-primary-menu" class="nav yamm">
                                    ...
                                    <li class="yamm-fw menu-item menu-item-has-children animate-dropdown dropdown">
                                        <a title="Pages" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true" href="#">Sản Phẩm<span class="caret"></span></a>
